...
#SBATCH --job-name=128Threads_test
...
id_start="9128"
id_end="128"
sub_save_folder="${id_start}_threads_${id_end}/"
...
THREADS_PER_SIM=128   # OpenMP threads per sim (make sure MAX_PAR*THREADS_PER_SIM fits your CPU)
