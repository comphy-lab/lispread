...
from libraries.create_all_plots_force_D import create_all_plots #create_all_plots_power05, create_all_plots_linear, 
...
for key in folder_dict.keys():
    ...
    #     0.72, 
    #     1.25])
    create_all_plots(folders, fig_save_dir="figures/water/force_D/", forced_exponent=forced_exponent ,
                            forced_dt=forced_dt, t_end=t_end, plot_individual_plots=False, h=h, save_plots=save_plots, 
                            linestyle=linestyles[i-1], marker=marker, skip_Oh=skip_Oh, forced_D=forced_D)
    if save_plots:
        ...
        for i in range(len(n_figs)):
            ...
            save_plot(n_figs[i], "figures/water/force_D/"+savenames[i])
        ...
        save_plot(99, "figures/water/force_D/"+"DvsOh.png")
        ...
        ax.legend([])  # This removes the original legend
        ax.legend(handles=handles, labels=labels, loc='best', fontsize=14, markerscale=1.5,)# Add the custom legend
        save_plot(63, "figures/water/force_D/"+"exponentvsOH.png")
