...
# Parameter sweeps
Ohf_list=("1e-2" "5e-2" "0.2" "0.5" "1" "2.5" "5" "10")
Ohd_list=(  "9.1e-5")
tmax_list=( "3" "3" "3" "3" "5" "5" "5" "5")
Ohe_list=( 1e-3 1e-2)
sigma2_list=( "0.33" )
sigma1_list=( "0.67" )
MAXlevel_list=( "12")
...
SBATCH_JOB_NAME="2750_to_2765"
SBATCH_ARRAY="2750-2765"
SBATCH_TIME="96:00:00"

# base save directory
base_save_dir="Results/${SBATCH_ARRAY}"
PARAMS_FILE="bash_scripts/2750_to_2765/params_list_${SBATCH_ARRAY}.txt"
EXE="./bubbleAtLubis"
SBATCH_MEM="251G"
