...
n_figs = [2, 3, 4, 11, 10, 124]
savenames = ["rvst_originol.png", "rvst_originol_log.png", "rvst_corrected_log.png",  
            "vvst_original.png", "vvst_filtered.png", "tmsvsrmum.png"]
...
for key in folder_dict.keys():
    ...
    if save_plots:
        ...
        for i in range(len(n_figs)):
            ...
            save_plot(n_figs[i], "figures/water/h_0p05/"+savenames[i])
        ...
        save_plot(99, "figures/water/h_0p05/"+"DvsOh.png")
        ...
        ax.legend([])  # This removes the original legend
        ax.legend(handles=handles, labels=labels, loc='best', fontsize=14, markerscale=1.5,)# Add the custom legend
        save_plot(63, "figures/water/h_0p05/"+"exponentvsOH.png")
        save_plot(444, "figures/water/h_0p05/rvst_collapsed.png")
        save_plot(5, "figures/water/h_0p05/rvstD_corrected_log.png")
