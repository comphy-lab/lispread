...
from libraries.create_all_plots_diff_OHe import create_all_plots #create_all_plots_power05, create_all_plots_linear, 
...
main_directory = "/media/markEnAman/Mark2000/discoverer"

forced_dt = None
folders = [main_directory + "/" + d for d in os.listdir(main_directory) if d[0]=="2" ] 

temp_folder_names=load_folders(folders)
# print(temp_folder_names)
folder_dict = {}
save_plots = True
plot_triangle_with_labels((3*4, 2e-1/2), ( 3*4, 5e-1/2), (3/5*4, 5e-1/2),  figure=99, l1=1, l2=2,
    l1_center = ["right", "center"], l2_center = ["right", "bottom"])
...
# forced_dt = [1e-10, 1e-10, 0.028169946647334156, 0.02795878134938001, 0.0363568386526328, 1e-10, 1e-10, 0.03758634152578523, 1e-10, 1e-10, 0.07149119621939201, 0.07807491510364416, 0.10571989308054124, 0.11283454175721903, 0.12305818430893026, 0.14028593096360198, 0.15063787423342426, 0.1603664902485833, 0.17163293195802326, 0.18043828320136265, 0.31366131695333904], [1e-10, 1e-10, 0.031139560246148317, 0.031143647643576335, 1e-10, 0.036457774161345026, 0.036505225929549995, 0.03735896312837358, 0.06302789840312899, 0.06536348214554812, 0.06869582794898621, 0.0740355128579213, 0.10154504928701096, 0.10983598090468154, 0.11164888903243725, 0.1291212268912657, 0.14187742953130955, 0.15354437895903525, 0.16785417924966714, 0.19014809310866013, 0.32639184389611403, 0.32182970790975, 0.32716107534288363, 0.29512579291074936], [1e-10, 0.03239920692755212, 0.03267123315771718, 1e-10, 0.03715252330514228, 0.037597018925096065, 0.038139839935800536, 0.039270545618662035, 0.0638635673493259, 0.0660005957825064, 0.06889711012740542, 0.07397440469913236, 0.10561632306670625, 0.11246711170050017, 0.12221024904365459, 0.13092667404271172, 0.14792976171719877, 0.1581748658961034, 0.1705314835460616, 0.18934840742600556, 0.2882429887757862, 0.2749687905685752, 0.3043182686306024]
# forced_dt = None
for key in folder_dict.keys():
    ...
    Ohf_, D_, t_start_, h_, Ohd_ = create_all_plots(folders, fig_save_dir="figures/bubble/diffOhe/", forced_exponent=0.5 ,
                            forced_dt=forced_dt, t_end=None, plot_individual_plots=False, h=h, save_plots=True, 
                             r_fitrange=r_fitrange, skip_Oh=[0.2, 0.5, 1, 2.5, 10])
...
if leg:
    leg.remove()
save_plot(99, "figures/bubble/diffOhe/"+"DvsOh.png")
...
# plt.xlim(1e-1, 1.5e3)
save_plot(1, "figures/bubble/diffOhe/"+"DvsOh_legend.png")
plt.close('all')